    ...
    <header className="sticky top-0 z-20 border-b border-ink-200 bg-white">
      <div className="flex min-h-16 items-center justify-between gap-3 px-4 py-3 sm:px-6">
        <div className="flex min-w-0 items-center gap-3">
          <button
            className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border border-ink-200 text-ink-700 hover:bg-ink-50 lg:hidden"
        ...
        <div className="flex min-w-0 items-center gap-2">
          ...
          <button
            className="flex h-10 items-center gap-2 rounded-md border border-ink-200 px-3 text-sm font-medium text-ink-700 hover:bg-ink-50 disabled:cursor-not-allowed disabled:opacity-70"
            disabled={loggingOut}
            onClick={onLogout}
            type="button"
          >
